...
export type LavalinkSource = string | "bandcamp" | "local" | "soundcloud" | "twitch" | "vimeo" | "youtube";

export type LoadType = "LOAD_FAILED" | "NO_MATCHES" | "PLAYLIST_LOADED" | "SEARCH_RESULT" | "TRACK_LOADED";
