        ...
        if (channel instanceof TextChannel) {
                ...
                await ctx
                    .send({
                        embeds: [
                            createEmbed(
                                "info",
                                "**please wait until the timeout over or response has given**"
                            )
                        ]
                    })
                    .then(
            ...
            const send = await ctx.send({
                embeds: [
                    createEmbed(
                        "info",
                        `**Are you sure to Nuke Channel \`${channel.name}\`?**`
                    )
                ],
                components: [row]
            });
                    ...
                    void ctx
                        .send({
                            embeds: [
                                createEmbed(
                                    "success",
                                    `**<a:accept:884700222951931964> | Nuke Channel **\`${channel.name}\`** successful!**`
                                )
                            ],
                            components: []
                        })
                        ...
                        void x.send({
                            embeds: [
                                createEmbed("info")
                                    ...
                                    .setImage(
                                        "https://cdn.discordapp.com/attachments/795512730940735508/801765196989071390/explosion.gif"
                                    )
                                    .setTimestamp()
                                    .setFooter({
                    ...
                    void ctx
                        .send({
                            embeds: [
                                createEmbed(
                                    "error",
                                    `**<a:decline:879311910045097984> | Nuke Channel **\`${channel.name}\`** has canceled!**`
                                )
                            ],
                            components: []
                        })
